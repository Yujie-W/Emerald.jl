...
dim_nir(::WaveLengthSet{FT,DIM_NIR,DIM_PAR,DIM_SIF,DIM_SIFE,DIM_WL}) where {FT,DIM_NIR,DIM_PAR,DIM_SIF,DIM_SIFE,DIM_WL} = DIM_NIR;
dim_par(::WaveLengthSet{FT,DIM_NIR,DIM_PAR,DIM_SIF,DIM_SIFE,DIM_WL}) where {FT,DIM_NIR,DIM_PAR,DIM_SIF,DIM_SIFE,DIM_WL} = DIM_PAR;
dim_sif(::WaveLengthSet{FT,DIM_NIR,DIM_PAR,DIM_SIF,DIM_SIFE,DIM_WL}) where {FT,DIM_NIR,DIM_PAR,DIM_SIF,DIM_SIFE,DIM_WL} = DIM_SIF;
dim_sife(::WaveLengthSet{FT,DIM_NIR,DIM_PAR,DIM_SIF,DIM_SIFE,DIM_WL}) where {FT,DIM_NIR,DIM_PAR,DIM_SIF,DIM_SIFE,DIM_WL} = DIM_SIFE;
dim_wl(::WaveLengthSet{FT,DIM_NIR,DIM_PAR,DIM_SIF,DIM_SIFE,DIM_WL}) where {FT,DIM_NIR,DIM_PAR,DIM_SIF,DIM_SIFE,DIM_WL} = DIM_WL;
